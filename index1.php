...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Kisii County Veterinary Management </h4></a>
    ...
    animation: mover 1s infinite alternate;"><br><br><br><br>
    <h1 style="color: white">WELCOME</h1>
  <h2 style="color: white":  sans-serif;">We are here for you!</h2> </div>

      <div style="color: white;">
  <p>Welcome to your trusted partner in pet care. <br>
    Our dedicated team of professionals strives to <br>
    provide the best possible care for your beloved companions. <br>
    With our state-of-the-art facilities and compassionate approach, <br>
    we ensure that your pets receive the highest quality treatment <br>
    <br>and attention they deserve.</p>
  
  <p>Contact us today to schedule an appointment<br>
     or to learn more about our services. <br>
     Your pet's health and happiness are our top priorities!</p>
  
  <p>Contact: 071909833</p>
</div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Client Login</h3><br>
