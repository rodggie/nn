    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query
          ($con,
          "insert into appointmenttb(pid,fname,lname,gender,email,contact,animaltype,petname,doctor,docFees,appdate,apptime,userStatus,doctorStatus)values($pid,'$fname','$lname','$gender','$email','$contact','$animaltype','$petname','$doctor','$docFees','$appdate','$apptime','1','1')");
...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    $output .= '
    <label> Cliet ID : </label>'.$row["pid"].'<br/><br/>
    <label> Appointment ID : </label>'.$row["ID"].'<br/><br/>
    <label> Cliet Name : </label>'.$row["fname"].' '.$row["lname"].'<br/><br/>
    <label> Veterinary Name : </label>'.$row["doctor"].'<br/><br/>
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Kisii County Veterinary Management</h2></br>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-4">
                      ...
                      document.getElementById('spec').onchange = function foo() {
                        ...
                        docs.forEach((el, ind, arr)=>{
                          ...
                          if (el.getAttribute("data-spec") != spec || parseInt(el.getAttribute("data-approved")) == 1) {
              ...
              document.getElementById('doctor').onchange = function updateFees(e) {
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-4">
              <label for="spec">Animal Type:</label>
                </div>
          <div class="col-md-8">
              <input type="text" class="form-control" name="animaltype" required="required">
          </div>
          <div class="col-md-4">
              <label for="spec">Animal Name:</label>
                </div>
          <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" name="animalbreed" >
            </div><br><br>
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" name="currentmedications">
            </div><br><br>
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" name="pastillness" >
            </div><br><br>

            <div class="col-md-4">
                <label for="supplimentdiet">Supplement Diet:</label>
            </div>
            <div class="col-md-8">
                <input type="text" class="form-control" name="supplimentdiet" >
            </div><br><br>
