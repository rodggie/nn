...
// PHP code to generate the message count
$messageCount = 0; // Replace with the actual number of messages you have.

// Optionally, you can generate messages as well.
$notificationMessage = "You have $messageCount new appointment requests.";
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-not" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Notifications (<?php echo $messageCount; ?>)</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;"> Notifications</h4>
                        
                      <p class="links cl-effect-1">
                        <a href="#list-not" onclick="clickDiv('#list-pres-list')">
                          Notification List
                        </a>
                      </p>
                      <div id="notification-container">
        <!-- Display the notification with message count -->
        <div class="notification">
            You have <span id="message-count"><?php echo $messageCount; ?></span> new appointment requests.
        </div>
    </div>
                    </div>
                  </div>
